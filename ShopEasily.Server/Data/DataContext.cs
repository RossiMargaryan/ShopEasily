...
namespace ShopEasily.Server.Data
{
    public class DataContext : DbContext
    {
        ...
        // Represents the Editions table in the database
        public DbSet<Edition> Editions { get; set; }

        // Represents the Stats table in the database
        public DbSet<Stats> Stats { get; set; }



        // Configures the database relationships and seeds initial data
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product
                {
                    ...
                    Image = "https://rukminim2.flixcart.com/image/850/1000/xif0q/book/q/d/5/nineteen-eighty-four-original-imagwvcxz55ugw4t.jpeg?q=20&crop=false",
                    DateCreated = new DateTime(2021, 1, 1)
                },
                new Product
                {
                    ...
                    Image = "https://filmphotographyproject.com/wp-content/uploads/2017/03/spotmatic.jpeg",
                    DateCreated = new DateTime(2021, 1, 1)
                },
                new Product
                {
                    ...
                    Image = "https://www.itinternational.pk/wp-content/uploads/2020/12/Microsoft-Xbox-One-X-1TB-Price-in-Pakistan.jpg",
                    DateCreated = new DateTime(2021, 1, 1)
                },
                new Product
                {
                    ...
                    Image = "https://files.refurbed.com/pi/super-nintendo-classic-mini-1646055879.jpg",
                    DateCreated = new DateTime(2021, 1, 1)
                },
                new Product
                {
